...
- [Smederee](https://smeder.ee/) - A full web darcs platform dedicated to help people build great software together. ([Demo](https://smeder.ee/), [Source Code](https://smeder.ee/~jan0sch/smederee)) `AGPL-3.0` `Scala`
